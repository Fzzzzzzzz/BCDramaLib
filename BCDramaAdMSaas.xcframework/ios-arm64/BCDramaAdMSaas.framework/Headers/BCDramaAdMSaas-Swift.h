...
#ifndef BCDRAMAADMSAAS_SWIFT_H
#define BCDRAMAADMSAAS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BCDramaAdMSaas",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14BCDramaAdMSaas16BCMSaasAdAdapter")
@interface BCMSaasAdAdapter : NSObject <BCAdAdapter, BCBannerAdAdapter, BCFullScreenAdAdapter, BCMSaasPlaybackAdapter, BCNativeExpressAdAdapter, BCRewardAdAdapter>
