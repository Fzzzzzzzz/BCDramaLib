...
#ifndef BCDRAMAADGDT_SWIFT_H
#define BCDRAMAADGDT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BCDramaAdGDT",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12BCDramaAdGDT14BCGDTAdAdapter")
@interface BCGDTAdAdapter : NSObject <BCAdAdapter, BCBannerAdAdapter, BCFullScreenAdAdapter, BCNativeExpressAdAdapter, BCRewardAdAdapter>
