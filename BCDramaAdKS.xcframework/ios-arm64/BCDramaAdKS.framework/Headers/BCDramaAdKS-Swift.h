...
#ifndef BCDRAMAADKS_SWIFT_H
#define BCDRAMAADKS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BCDramaAdKS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11BCDramaAdKS13BCKSAdAdapter")
@interface BCKSAdAdapter : NSObject <BCAdAdapter, BCBannerAdAdapter, BCFullScreenAdAdapter, BCNativeExpressAdAdapter, BCRewardAdAdapter>
